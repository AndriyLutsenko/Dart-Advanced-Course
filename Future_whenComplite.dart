...
void main() async {
 print("1  synchro 1");
  ...
  await Future((){c=555;})
   .then((_)=> print("Test $c"))
   .then((_){c=777; throw Exception();})
   .then((_)=> print("Test 1 $c"))          //не виконається
   .whenComplete(()=>print ('о бля $c'))
   .catchError((e)=>print('Future error'))
   .then((_)=> print("Test 2 $c"))
   .whenComplete(()=>print ('бля'))
   .then((_)=>  throw Exception())
   .then((_)=> print("Test 3"))       //не виконається
   .catchError((e)=>print('Future error 2'))
   .whenComplete(()=>print ('ну бля'));
  // A();
  // B();
